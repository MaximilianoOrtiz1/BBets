...
p_no_match <- prod((365:(365 - n + 1)) / 365)

# Probability of at least one shared birthday
p_match <- 1 - p_no_match

# Fair odds (ratio of expected loss to win)
fair_odds <- (1 - p_match) / p_match
...
The odds that at least one birthday is shared is 0.8143832. The fair odds are 0.227923.
...
repeat {
  p_no_match <- p_no_match * (365 - (n - 1)) / 365
  if (p_no_match <= target) break
  n <- n + 1
}
...
For a class size of 18, there is are 2:1 odds
